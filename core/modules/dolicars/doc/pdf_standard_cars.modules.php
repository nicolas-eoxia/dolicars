...
/**
 *  \file       core/modules/dolicars/doc/pdf_standard.modules.php
 *  \ingroup    dolicars
...
/**
 *	Class to manage PDF template standard_cars
 */
class pdf_standard_cars extends ModelePDFCars
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_CARS_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->dolicars->dir_output.'/cars') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->dolicars->dir_output.'/cars';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->dolicars->dir_output.'/cars/'.$objectref;
