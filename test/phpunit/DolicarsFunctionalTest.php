...
/**
 * \file    test/phpunit/DolicarsFunctionalTest.php
 * \ingroup dolicars
 ...
 *
 * @package Testdolicars
 */
class DolicarsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolicars/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolicars/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolicars/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolicars/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolicarswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDolicars_DolicarsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDolicars_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
